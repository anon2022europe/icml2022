...
if __name__ == "__main__":
    ...
    if args.config is None:
        configs_name = ["report_base_qm9_RF1",
                        "report_base_qm9_RF2",
                        "report_base_comm20_RF1", "report_base_comm50_RF1",
                        "report_base_comm50_RF2", "report_base_comm100_RF1", "report_base_comm100_RF2",
                        "report_base_comm200_RF1"
                        "report_base_qm9_gen1", "report_base_comm50_smaller",
                        "report_base_comm100_smaller", "report_base_comm200_smaller", 'report_base_comm20_smaller'
