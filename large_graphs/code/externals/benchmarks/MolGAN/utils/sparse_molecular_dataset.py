...
from externals.benchmarks.MolGAN.utils.progress_bar import ProgressBar
...
if __name__ == "__main__":
    ...
    data.generate(
        "/media/anons/Main/University/PhD/Projects_Repos/GraphGAN/graph-gan-main/code/"
        "externals/benchmarks/MolGAN/data/gdb9.sdf",
        filters=lambda x: x.GetNumAtoms() <= 9,
        size=5000,
    )
    data.save(
        "/media/anons/Main/University/PhD/Projects_Repos/GraphGAN/graph-gan-main/code/"
        "externals/benchmarks/MolGAN/data/QM9_5k_ori_Mg.sparsedataset"
    )
