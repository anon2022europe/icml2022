...
class Generator(nn.Module):
    ...
    def root_forward(self, batch_size=1, device=None, Z=None, X=None, A=None, N=None, joined_embed=None):
        if X is None:
            X, A, N, Z = self.root.forward(batch_size, device, Z=Z, N=N, joined_embed=joined_embed)
        self.maybe_histogram(A, N, X, "root")
        return X, A, N, Z

    def feature_forward(
        self, batch_size=1, device=None, Z=None, X=None, A=None, N=None, joined_embed=None
    ):
        X, A, N, Z = self.root_forward(batch_size, device, Z, X, A, N, joined_embed=joined_embed)
    ...
    def forward(self, batch_size=1, device=None, Z=None, X=None, A=None, N=None, joined_embed=None):
        X, A, N, Z = self.feature_forward(batch_size, device, Z, X, A, N, joined_embed=joined_embed)
